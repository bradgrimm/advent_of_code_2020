...
def load_day(day, sample=False, split=True):
    name = 'day_{}_sample'.format(day) if sample else 'day_{}'.format(day)
    puzzle_path = os.path.join(ROOT_DIR, '../puzzle_inputs/{}'.format(name))
...
"""
The following is from and is used in Day 13:
